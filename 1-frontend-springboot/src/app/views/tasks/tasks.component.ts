...
export class TaskListComponent implements OnInit {
    ...
    assignTableSource() {
        ...
        this.dataSource.data = this.tasks as Task[]; // обновить источник данных (т.к. данные массива tasks обновились)
...
// в это событие попадает как переход на другую страницу (pageIndex), так и изменение кол-ва данных на страниц (pageSize)
    ...
    initSearch() {
        ...
        this.taskSearchValues!.title = this.filterTitle as string;
        this.taskSearchValues!.completed = this.filterCompleted;
        this.taskSearchValues!.priorityId = this.filterPriorityId;
        this.taskSearchValues!.sortColumn = this.filterSortColumn as string; 
        this.taskSearchValues!.sortDirection = this.filterSortDirection as string;

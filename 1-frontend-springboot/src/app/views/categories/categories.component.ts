...
export class CategoriesComponent implements OnInit {
    ...
    selectedCategory: Category | undefined; // если равно null - по-умолчанию будет выбираться категория 'Все' - задачи любой категории (и пустой в т.ч.)
    ...
    search() {
        ...
        this.categorySearchValues.title = this.filterTitle as string | undefined;
    ...
    showCategory(category?: Category | null) {
        ...
        this.selectedCategory = category as Category; // сохраняем выбранную категорию
    ...
    openEditDialog(category: Category) {
        const dialogRef = this.dialog.open(EditCategoryDialogComponent, {
            ...
            data: [new Category(category.id as number, category.title), 'Редактирование категории'], width: '400px'
        });

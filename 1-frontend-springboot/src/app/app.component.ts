...
// были ли изменены настройки приложения
    ...
    updateCategoryCounter(category: Category) {
        ...
        this.categoryService.findById(category.id as number).subscribe(cat => { // получить из БД актуальные данные
